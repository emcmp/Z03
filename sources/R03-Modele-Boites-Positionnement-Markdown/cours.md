...
![Des couleurs de fond rendent les boîtes HTML visibles](assets/boites-rendues-visibles.png)
...
![Schéma du modèle de boîte CSS](assets/modele-de-boite-css.png)
...
![Une boîte dont la hauteur totale comprend le contenu, le remplissage, la bordure et les marges](assets/dimensions-totales-boite.png)
...
![Deux boîtes utilisant des bordures différentes](assets/exemple-bordures.png)
...
![Comparaison des espacements autour de deux boîtes](assets/marges-et-remplissage.png)
...
![Un élément span affiché dans une ligne de texte](assets/element-inline.png)
...
![Deux paragraphes transformés en boîtes inline-block](assets/elements-inline-block.png)
...
![Un menu horizontal construit avec inline-block](assets/menu-horizontal.png)
...
![Comparaison des valeurs visible, hidden, auto et scroll](assets/valeurs-overflow.png)
...
![Des boîtes placées dans le flux normal](assets/flux-normal.png)
...
![Une boîte décalée avec position relative](assets/position-relative.png)
...
![Un enfant en position absolue dans un parent en position relative](assets/position-absolute.png)
...
![Une boîte fixée dans le coin de la fenêtre](assets/position-fixed.png)
...
![Plusieurs boîtes superposées avec z-index](assets/superposition-z-index.png)
...
![Un paragraphe dont le style change au survol](assets/pseudo-classe-hover.png)
...
![Résultat d’un sélecteur d’enfant direct](assets/selecteur-enfant.png)
...
![Plusieurs éléments mis en forme par une règle groupée](assets/selecteurs-groupes.png)
...
![Une boîte avec une ombre portée](assets/ombre-portee.png)
...
Ce chapitre est une adaptation éditoriale du diaporama **R03 — Modèle en boîtes et positionnement**. Les médias originaux extraits sont conservés dans `assets/originaux/`, et les images retenues pour le cours portent des noms descriptifs dans `assets/`.
