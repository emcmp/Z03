---
id: cours-introduction-html
title: Cours — Introduction à HTML
description: Découvrir la structure d’une page Web et créer ses premiers documents HTML
slug: /cours/introduction-html
sidebar_position: -2
---
...
![Logos de HTML et CSS](../../static/img/cours-introduction-html/logos-html-css.png)
...
:::info HTML et CSS travaillent ensemble

HTML décrit le contenu et sa structure. La mise en forme visuelle sera principalement le rôle de CSS.
...
![Anatomie d’un élément HTML avec un attribut](../../static/img/cours-introduction-html/anatomie-element-html.png)
...
![Structure minimale d’un document HTML](../../static/img/cours-introduction-html/structure-document-html.png)
...
![Rendu des différents niveaux de titres](../../static/img/cours-introduction-html/rendu-titres-html.png)
...
![Rendu d’une liste à puces et d’une liste numérotée](../../static/img/cours-introduction-html/rendu-listes-html.png)
...
![Exemple d’image affichée dans le navigateur](../../static/img/cours-introduction-html/exemple-image-html.png)

:::warning Attention au texte alternatif
...
:::tip Organiser les fichiers

Placez les images du site dans un dossier `images`. Des dossiers simples et des noms de fichiers clairs facilitent beaucoup l’écriture des chemins relatifs.
...
![Page d’accueil avec un lien vers la page À propos](../../static/img/cours-introduction-html/navigation-page-accueil.png)

Page À propos :

![Page À propos avec un lien vers l’accueil](../../static/img/cours-introduction-html/navigation-page-a-propos.png)
...
:::warning Une page affichée n’est pas nécessairement valide

Une page peut sembler fonctionner même si son HTML contient des erreurs. La validation permet de découvrir des problèmes que le navigateur tente parfois de corriger silencieusement.

:::

La validation aide notamment à repérer :
...
![Interface du validateur HTML du W3C](../../static/img/cours-introduction-html/validateur-w3c.png)

Corrigez les erreurs une à une, puis relancez la validation jusqu’à obtenir un document sans erreur.

![Message indiquant que la validation est réussie](../../static/img/cours-introduction-html/validation-reussie.png)
