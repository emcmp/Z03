---
id: cours-introduction-css
title: Cours — Introduction à CSS
description: Mettre en forme une page Web avec des sélecteurs et des règles CSS
slug: /cours/introduction-css
sidebar_position: -1
---
...
![Logo de CSS](../../static/img/cours-introduction-css/logo-css.png)
...
La méthode à privilégier consiste à placer les règles dans un fichier séparé, par exemple `styles.css`. Une seule feuille peut alors servir à plusieurs pages.
...
:::info Une classe est réutilisable

Une classe peut être appliquée à plusieurs éléments. Un élément peut aussi posséder plusieurs classes, séparées par des espaces.
...
![Plusieurs paragraphes regroupés dans un div](../../static/img/cours-introduction-css/groupement-div-rendu.png)
...
![Représentation de l’élément main](../../static/img/cours-introduction-css/structure-main.png)

:::tip Préférer un élément qui décrit le contenu

Ces éléments peuvent recevoir des classes et des styles exactement comme un `<div>`, tout en donnant plus de sens à la structure. Utilisez `<div>` lorsqu’aucun élément sémantique ne convient.
...
![Exemple d’un mot entouré d’une bordure](../../static/img/cours-introduction-css/bordure-rendu.png)
...
![Exemples d’alignement du texte](../../static/img/cours-introduction-css/alignement-texte.png)
...
![Texte sans trait, souligné et rayé](../../static/img/cours-introduction-css/decoration-texte.png)

:::danger Liens difficiles à reconnaître
...
![Exemples de styles de police](../../static/img/cours-introduction-css/styles-police.png)
...
![Comparaison de plusieurs tailles de texte](../../static/img/cours-introduction-css/tailles-police.png)
