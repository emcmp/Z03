...
const PROJECT_STEPS: readonly ProjectStep[] = [
  {
    ...
    summary: "Un thème principal, deux sous-thèmes et une première page d’accueil.",
    mission: "Définir la structure de votre futur site et présenter clairement son thème principal.",
    outcome: "un thème personnel, deux sous-thèmes planifiés et une page d’accueil HTML complète.",
  ...
  },
  {
    step: 2,
    verb: "Développer",
    title: "Le site de trois pages",
    summary: "Une page d’accueil, deux sous-thèmes, des images locales et une navigation complète.",
    mission: "Transformer la page d’accueil en un vrai petit site dont chaque page possède un rôle distinct.",
    outcome: "trois pages reliées, au moins deux images locales et des chemins relatifs qui fonctionnent partout.",
  ...
  },
  {
    ...
    mission: "Donner une identité visuelle commune aux trois pages sans recopier les mêmes styles.",
  ...
  },
  {
    ...
    summary: "Une disposition Flexbox utile et un site HTML/CSS cohérent avant JavaScript.",
    mission: "Utiliser Flexbox dans un besoin concret, puis corriger et consolider les trois pages.",
