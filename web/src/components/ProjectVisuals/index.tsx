...
const PROJECT_STEPS: readonly ProjectStep[] = [
  ...
  },
  {
    ...
    summary: "Une feuille CSS partagée, des classes réutilisables et un identifiant unique.",
    mission: "Donner une identité visuelle commune aux quatre pages en choisissant entre sélecteurs d’élément, classes et identifiants.",
    outcome: "une feuille CSS partagée, des décisions visuelles cohérentes, des classes réutilisables et un élément ciblé par son id.",
