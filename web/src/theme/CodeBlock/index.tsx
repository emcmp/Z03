...
const rules: PreviewRule[] = [
  ...
  { code: `.carte {\n  padding: 20px;\n}`, src: "examples/peek/r4-padding-only.html", title: "Rendu d'un padding uniforme", label: "Voir le padding", height: 170 },
  ...
  { code: `.carte {\n  border: 2px solid #245a86;\n}`, src: "examples/peek/r4-border-only.html", title: "Rendu d'une bordure autour d'une carte", label: "Voir la bordure", height: 150 },
  { code: `.carte {\n  width: 320px;\n}`, src: "examples/peek/r4-width.html", title: "Rendu d'une carte de 320 pixels", label: "Voir la largeur", height: 130 },
  { code: `.image-principale {\n  width: 80%;\n  height: auto;\n}`, src: "examples/peek/r4-width-percent.html", title: "Rendu d'une image à 80 pour cent du parent", label: "Voir 80 %", height: 230 },
  { code: `img {\n  max-width: 100%;\n  height: auto;\n}`, src: "examples/peek/r4-responsive-image.html", title: "Image limitée à la largeur de son conteneur", label: "Voir l'image adaptable", height: 230 },
  ...
  { code: `justify-content: flex-start;`, src: "examples/peek/r5-start.html", title: "Rendu avec justify-content flex-start", label: "Voir flex-start", height: 100 },
  ...
  { code: `.navigation a:hover {\n  background-color: #245a86;\n  color: white;\n}`, src: "examples/peek/r5-extra-hover.html", title: "Rendu de hover sur des liens", label: "Tester hover", height: 125 },
  { code: `.navigation a {\n  transition: background-color 0.5s, color 0.5s;\n}`, src: "examples/peek/r5-extra-transition.html", title: "Comparaison sans et avec transition", label: "Tester transition", height: 135 },
  { code: `.carte {\n  border-radius: 12px;\n}`, src: "examples/peek/r5-extra-border-radius.html", title: "Comparaison des coins droits et arrondis", label: "Voir border-radius", height: 120 },
  { code: `.carte {\n  box-shadow: 0 4px 12px rgb(0 0 0 / 20%);\n}`, src: "examples/peek/r5-extra-box-shadow.html", title: "Comparaison sans et avec ombre", label: "Voir box-shadow", height: 130 },
  { code: `.carte:hover {\n  transform: scale(1.03);\n}`, src: "examples/peek/r5-extra-scale.html", title: "Rendu d'un léger agrandissement au survol", label: "Tester scale", height: 180 },
  { code: `.contenu-banniere {\n  background-color: rgb(0 0 0 / 55%);\n}`, src: "examples/peek/r5-extra-alpha.html", title: "Rendu d'un fond avec transparence alpha", label: "Voir l'alpha", height: 180 },
  { code: `h1 {\n  text-shadow: 0 2px 4px rgb(0 0 0 / 50%);\n}`, src: "examples/peek/r5-extra-text-shadow.html", title: "Comparaison du titre sans et avec ombre", label: "Voir text-shadow", height: 180 },
  { code: `.banniere {\n  background: linear-gradient(135deg, #245a86, #7a1f1f);\n  color: white;\n  padding: 48px 20px;\n}`, src: "examples/peek/r5-extra-gradient.html", title: "Rendu d'un fond en dégradé", label: "Voir le dégradé", height: 170 },
  { code: `.navigation a {\n  border-radius: 8px;\n  transition: background-color 0.2s, color 0.2s;\n}\n\n.navigation a:hover {\n  background-color: #245a86;\n  color: white;\n}\n\n.carte {\n  border-radius: 12px;\n  box-shadow: 0 4px 12px rgb(0 0 0 / 20%);\n  transition: transform 0.2s;\n}\n\n.carte:hover {\n  transform: scale(1.03);\n}\n\n.contenu-banniere {\n  background-color: rgb(0 0 0 / 55%);\n  color: white;\n  padding: 20px;\n  border-radius: 12px;\n  text-shadow: 0 2px 4px rgb(0 0 0 / 50%);\n}`, src: "examples/peek/r5-extras-complete.html", title: "Exemple combiné de plusieurs extras visuels", label: "Voir les extras combinés", height: 360 },
  { code: `.navigation a {\n  background-color: #eaf3ff;\n  color: #245a86;\n  padding: 10px 14px;\n  text-decoration: none;\n  border-radius: 8px;\n  transition: background-color 0.2s, color 0.2s;\n}\n\n.navigation a:hover {\n  background-color: #245a86;\n  color: white;\n}`, src: "examples/peek/r5-hover-transition.html", title: "Rendu d'une navigation avec hover et transition", label: "Tester le survol", height: 120 },
  { code: `.carte {\n  border-radius: 12px;\n  box-shadow: 0 4px 12px rgb(0 0 0 / 20%);\n  transition: transform 0.2s;\n}\n\n.carte:hover {\n  transform: scale(1.03);\n}`, src: "examples/peek/r5-card-effects.html", title: "Rendu d'une carte avec ombre et effet de survol", label: "Tester la carte", height: 190 },
  { code: `.banniere {\n  background-image: url("../images/sentier.svg");\n  background-size: cover;\n  background-position: center;\n  padding: 48px 20px;\n}\n\n.contenu-banniere {\n  background-color: rgb(0 0 0 / 55%);\n  color: white;\n  padding: 20px;\n  border-radius: 12px;\n}`, src: "examples/peek/r5-alpha.html", title: "Rendu d'une boîte semi-transparente sur une image", label: "Voir la transparence", height: 230 },
