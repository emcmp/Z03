...
const rules: PreviewRule[] = [
  ...
  { code: `<a href="contact.html">Contact</a>`, src: "examples/peek/r2-link.html", title: "Rendu d'un lien HTML", label: "Voir le lien", height: 90 },
  { code: `<a href="../index.html">Accueil</a>`, src: "examples/peek/r2-link.html", title: "Rendu d'un lien HTML", label: "Voir le lien", height: 90 },
  { code: `<a href="https://www.w3.org/">Site du W3C</a>`, src: "examples/peek/r2-link.html", title: "Rendu d'un lien externe", label: "Voir le lien", height: 90 },
